                                    ...
                                    <tr v-for="(item, index) in collection" :key="item.id"
                                        ...
                                        <td>
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-auto">
                                                    <a class="btn btn-sm btn-spinner btn-info"
                                                        :href="item.resource_url + '/user-detail'" title="User Grade Assign"
                                                        role="button"><i class="fa fa-clone"></i></a>
                                                </div>

                                                <div class="col-auto">
                                                    <a class="btn btn-sm btn-spinner btn-info"
                                                        :href="item.resource_url + '/user-enroll'" title="Show Classes"
                                                        role="button"><i class="fa fa-superpowers"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
